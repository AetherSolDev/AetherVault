...
- main_app_pyside.py (PySide6 GUI, ~1250 lines)
**AGENTS.md is read only**
**Last Updated:** 2026-07-24 00:33 CT (America/Chicago)
...
credentials
    ...
    title TEXT NOT NULL
    url TEXT, username TEXT, email TEXT
    password TEXT NOT NULL (AES-256 encrypted)
    phone TEXT, address TEXT, category TEXT, notes TEXT
